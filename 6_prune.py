...
if __name__ == '__main__':
    # Load a model
    yolo = YOLO("./runs/detect/train87/weights/best.pt")
    model = yolo.model
    ...
    # yolo.train(data="D:\PyCharm Community Edition 2024.1.4\PythonPreject\Awesome-Backbones-main\Yolov8\\v2.yaml", epochs=50)  # 剪枝后直接训练微调

    torch.save(yolo.ckpt, "./runs/detect/prune_88.pt")
    print("done")