...
if __name__ == '__main__':
    # 加载模型
    weight_path = r"D:\PyCharm Community Edition 2024.1.4\PythonPreject\Awesome-Backbones-main\Yolov8\runs\detect\train87\weights\best.pt"
    imgdir = r'E:\Video2Img_972'  # 图片路径
    xmldir = r'E:\Label_Video2Img_972'  # 标注文件保存路径
