...
'''
    VOC数据集格式转换成YOLO格式
    https://blog.csdn.net/qq_45754436/article/details/140205171?utm_medium=distribute.pc_relevant.none-task-blog-2~default~baidujs_baidulandingword~default-0-140205171-blog-125637099.235^v43^pc_blog_bottom_relevance_base6&spm=1001.2101.3001.4242.1&utm_relevant_index=3
    base_dir 为数据集根目录
    classes = ['Video']  # 类别
    annotations_dir = os.path.join(base_dir, 'E:\Label2') # xml标签位置
'''
# 数据集的类别
classes = ['Video']
...
# 定义图像和标签的输入目录
base_dir = 'D:\PyCharm Community Edition 2024.1.4\PythonPreject\Awesome-Backbones-main\Yolov8'
annotations_dir = os.path.join(base_dir, 'E:\Label2_1')
images_dir = os.path.join('E:\Video2Img_1')  # 修改后的图像存储目录
