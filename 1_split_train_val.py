...
'''
    --xml_path', default='E:\Label',
    --txt_path', default='Imagesets'
...
parser.add_argument('--xml_path', default='E:\\Label_Video2Img_972', type=str, help='input xml label path')
parser.add_argument('--txt_path', default='E:\\Video2Img_972', type=str, help='output txt label path')
opt = parser.parse_args()

trainval_percent = 0.8 # 表示train和val集合90%，test集合10%
train_percent = 0.6  # 表示train集合70%，val集合30%
